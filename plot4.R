...
# 2. Make plots
par(mfrow=c(2,2))  # Matrix for plots

plot(df$date_time, df$global_active_power, type = "l",  # Plot 1
     xlab = "",
     ylab = "Global Active Power (kilowatts)")

plot(df$date_time, df$voltage, type = "l",  # Plot 2
     xlab = "datetime",
     ylab = "Voltage")

plot(df$date_time, df$sub_metering_1, type = "l", col = "black",  # Plot 3
     xlab = "",
...
plot(df$date_time, df$global_reactive_power, type = "l",  # Plot 4
     xlab = "datetime",
